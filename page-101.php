...
get_header(); ?>
		...
		<div class="container">
			...
			<div class="row">
				<div class="left-box">
					<div class="name">RSP (Visually Handicapped)</div>
					<div class="logo">
						<img src="../wp-content/themes/stand-out/assets/img/rsp-logos/vh.jpg">
					</div>
					<div class="partners"> Partners:
						<ul>
							<li>Singapore Association of the Visually Handicapped (SAVH)</li>
						</ul>
					</div>
				</div>
				<div class="right-box">
			...
			<div class="row">
				<div class="left-box">
					<div class="name">RSP (Physically Challenged)</div>
					<div class="logo">
						<img src="../wp-content/themes/stand-out/assets/img/rsp-logos/pc.jpg">
					</div>
					<div class="partners"> Partners:
						<ul>
							<li>The Singapore Cheshire Home</li>
							<li>Friends of the Disabled Society (FDS)</li>
						</ul>
					</div>
				</div>
				<div class="right-box">
...
For more information, <a href="https://www.facebook.com/NTUWSC.RSPPC/">visit our official Facebook page!</a>
			...
			<div class="row">
				<div class="left-box">
					<div class="name">RSP (Mental Health)</div>
					<div class="logo">
						<img src="../wp-content/themes/stand-out/assets/img/rsp-logos/mh.jpg">
					</div>
					<div class="partners"> Partners:
						<ul>
							<li>Institute of Mental Health (IMH)</li>
						</ul>
					</div>
				</div>
				<div class="right-box">
...
Apart from weekly sessions at IMH every Saturday, which comprise of activities such as handicraft making and games, are held every Saturday, from 3pm to 5pm, at the Institute of Mental Health (IMH). The session comprises of befriending, handicrafts making, games and event celebrations such as Chinese New Year and Christmas Day.
			...
			<div class="row">
				<div class="left-box">
					<div class="name">RSP (Intellectually Disabled)</div>
					<div class="logo">
						<img src="../wp-content/themes/stand-out/assets/img/rsp-logos/id.jpg">
					</div>
					<div class="partners"> Partners:
						<ul>
							<li>MINDS Youth Group (MYG)</li>
						</ul>
					</div>
				</div>
				<div class="right-box">
...
For more information, <a href="https://www.facebook.com/ntuwsc.rspid/">visit our official Facebook page!</a>
			...
			<div class="row">
				<div class="left-box">
					<div class="name">RSP (Deaf Community)</div>
					<div class="logo">
						<img src="../wp-content/themes/stand-out/assets/img/rsp-logos/dc.jpg">
					</div>
					<div class="partners"> Partners:
						<ul>
							<li>Clementi Community Club</li>
							<li>Toa Payoh Community Club</li>
							<li>Republic Polytechnic</li>
							<li>Singapore Association for the Deaf (SADeaf)</li>
			...
			<div class="row">
				<div class="left-box">
					<div class="name">RSP (Youth)</div>
					<div class="logo">
						<img src="../wp-content/themes/stand-out/assets/img/rsp-logos/youth.jpg">
					</div>
					<div class="partners"> Partners:
						<ul>
							<li>Singapore Boys' Home</li>
							<li>Singapore Girls' Home</li>
							<li>Boys' Town</li>
							<li>BP</li>
							<li>Institute of Technical Education (College West)</li>
							<li>Sport Singapore</li>
							<li>Southwest CDC</li>
						</ul>
					</div>
				</div>
...
The objective of RSP (Youth) is to be "A Friend, A Mentor, A Teacher" to the youths we interact with by giving them support.
			...
			<div class="row">
				<div class="left-box">
					<div class="name">RSP (Friends of Children)</div>
					<div class="logo">
						<img src="../wp-content/themes/stand-out/assets/img/rsp-logos/foc.jpg">
					</div>
					<div class="partners"> Partners:
						<ul>
							<li>Whispering Hearts Family Service Centre</li>
							<li>Clementi Community Club</li>
							<li>Tasek Jurong Limited</li>
							<li>Students Care Services (Yishun)</li>
							<li>Students Care Services (Hougang)</li>
							<li>Nanyang Community Club</li>
							<li>Yuhua Community Club</li>
						</ul>
					</div>
				</div>
				<div class="right-box">
			...
			<div class="row">
				<div class="left-box">
					<div class="name">RSP (Operation Hope)</div>
					<div class="logo">
						<img src="../wp-content/themes/stand-out/assets/img/rsp-logos/oh.jpg">
					</div>
					<div class="partners"> Partners:
						<ul>
							<li>KK Women and Childrens' Hospital</li>
