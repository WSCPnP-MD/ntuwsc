			...
			$(this).click(function() {
				...
				switch (proj)
				{
					...
					case 'vh':
					{
						...
						updateContacts({'fb':"https://www.facebook.com/WSC.RSPVH/", 'instagram':"https://www.instagram.com/ntuwsc_rspvh/?hl=en"});
						break;
					}
					case 'pc':
					{
					...
					case 'id':
					{
						...
						updateContacts({'fb':"https://www.facebook.com/ntuwsc.rspid/", 'instagram':"https://www.instagram.com/ntuwsc_rspid/?hl=en"});
						break;
					}
					case 'dc':
					{
						...
						updateContacts({'fb':"https://www.facebook.com/ntuwscrspdc/", 'instagram':"https://www.instagram.com/ntuwsc_rspdc/?hl=en"});
						break;
					}
					case 'youth':
					{
						...
						updateContacts({'fb':"https://www.facebook.com/ntuwscrspyouth/", 'instagram':"https://www.instagram.com/ntuwsc_rspyouth/?hl=en"});
						break;
					}
					case 'foc':
					{
						...
						updateContacts({'fb':"https://www.facebook.com/NtuWscRSPFriendsOfChildren/", 'website':"http://wscrspfoc.weebly.com/", 'instagram':"https://www.instagram.com/ntuwsc_rspfoc/?hl=en"});
						break;
					}
					case 'elders':
					{
						...
						updateContacts({'fb':"https://www.facebook.com/NTUWSCRSPElders/", 'website':"http://ntuwscrspelders.wix.com/blog", 'instagram':"https://www.instagram.com/ntuwsc_rspelders/?hl=en"});
						break;
					}
					case 'oh':
					{
						...
						");
						updateContacts({'fb':"https://www.facebook.com/NTUOperationHope/", 'instagram':"https://www.instagram.com/ntuwsc_rspoh/?hl=en"});
						break;
					}
					/* special projects */
					case 'igc':
					{
						...
						updateContacts({'fb':"https://www.facebook.com/NTUWSCIgniteChange", 'website':"https://ignitechange-camp.weebly.com/", 'instagram':"https://www.instagram.com/ntuwsc_igc/?hl=en"});
						break;
					}
					case 'vm':
					{
						...
						updateContacts({'fb':"http://www.facebook.com/NtuWscVolunteerManagement", 'instagram':"https://www.instagram.com/ntuwsc_vm/?hl=en"});
						break;
					}
					case 'curl':
					{
						...
						updateContacts({'fb':"https://www.facebook.com/NTUWSCCurL/", 'instagram':"https://www.instagram.com/ntuwsc_curl/?hl=en"});
						break;
					}
					case 'cor':
					{
						...
						updateContacts({'fb':"https://www.facebook.com/campoutreach", 'instagram':"https://www.instagram.com/ntuwsc_cor/?hl=en"});
						break;
					} 
					case 'ove':
					{
						...
						updateContacts({'fb':"https://www.facebook.com/OverseasVolunteeringExpedition", 'instagram':"https://www.instagram.com/ntuwsc_ove/?hl=en"});
						break;
					}
					...
					case 'ir':
					{
						...
						updateContacts({'fb':"https://www.facebook.com/internalrelationswsc/", 'instagram': "https://www.instagram.com/ntuwsc_ir/?hl=en"});
						break;
					}
					case 'fc':
					{
					...
					case 'pnp':
					{
						updateInfoText("Publicity and Publications",
										"Publicity and Publications (PnP) is a Supporting Committee under WSC which comprises of the Design, Digital Imaging, IT,\
										Journalism and Public Relations divisions. PnP provides media coverages of most of the WSC portfolios, including the publishing\
										of the bi-annual StandOUT newsletters which aims to share the happenings within the WSC community and provide volunteering-related content. PnP also maintains a strong online presence for WSC on various platforms including the official website, social\
										media handles, e-Banner, Campus Buzz and campus notice board updates. In addition, PnP also keeps the media archives for\
										WSC up-to-date, and conducts annual design, journalism and digital imaging workshops for like-minded members. ");
						updateContacts({'fb': "https://www.facebook.com/WSCPnP/", 'instagram': "https://www.instagram.com/ntuwsc_pnp/?hl=en"});
						break;
					}
					case 'go':
					{
						...
						updateContacts({'fb': "https://www.facebook.com/ntuwscgrowthandopportunities/", 'instagram': "https://www.instagram.com/ntuwsc_go/?hl=en"});
						break;
					}
					default:
					{
