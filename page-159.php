...
<!--                </ul> -->
            ...
            <h2>RSP (Visually Handicapped)</h2>
            <h2>RSP (Hearing Impaired)</h2>
                <ul>
                    <li>National Youth Council</li>
                        <img src="../wp-content/themes/stand-out/assets/img/spons-logos/NYCS.jpg">
                </ul>
            <h2>RSP (Physically Challenged)</h2>
            <h2>RSP (Intellectually disabled)</h2>
            <h2>RSP (Youth)</h2>
                <ul>
            ...
            <h2>Ignite Change (IgC)</h2>
            <h2>Camp OutReach (COR)</h2>
                <ul>
                    <li>National Youth Council</li>
                        <img src="../wp-content/themes/stand-out/assets/img/spons-logos/NYCS.jpg">
            ...
            <h2>Overseas Volunteering Expedition (OVE)</h2>
                <ul>
                    <li>National Youth Council</li>
                        <img src="../wp-content/themes/stand-out/assets/img/spons-logos/NYCS.jpg">
                </ul>
